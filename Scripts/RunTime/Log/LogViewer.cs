...
public class LogViewer : MonoBehaviour {
    ...
    void LogReceived (string logString, string stackTrace, LogType type) {
        ...
        tmp.color = type
        switch { LogType.Assert => Color.cyan, LogType.Error => Color.red, LogType.Exception => Color.red, LogType.Log => Color.white, LogType.Warning => Color.yellow, _ => Color.gray };
